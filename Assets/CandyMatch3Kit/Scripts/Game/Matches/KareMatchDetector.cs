                ...
                for (var i = 0; i < board.level.width;)
                {
                    ...
                    if (tile != null && tile.GetComponent<Candy>() != null)
                    {
                        ...
                        if (board.GetTile(i + 1, j) != null && board.GetTile(i + 1, j).GetComponent<Candy>() != null &&
                            ...
                            board.GetTile(i + 1, j + 1) != null && board.GetTile(i + 1, j + 1).GetComponent<Candy>() != null &&
                            board.GetTile(i + 1, j + 1).GetComponent<Candy>().color == color && board.GetTile(i + 1, j + 1).GetComponent<StripedCandy>() == null && board.GetTile(i + 1, j + 1).GetComponent<WrappedCandy>() == null)
                        {
                            var match = new Match();
                            ...
                            match.AddTile(board.GetTile(i + 1, j + 1));
